...
class ShopVisitPageState extends State<ShopVisitPage> {
  ...
  final TextEditingController SMNameController = TextEditingController(text: userNames);
  ...
  Future<void> _checkUserIdAndFetchShopNames() async {
    ...
    var boxName = (userDesignation == 'SM') ? 'shopNames' : 'shopNamesByCities';
  ...
  Future<void> fetchBookerNamesBySMDesignation() async {
    loginViewModel.fetchBookerNamesBySMDesignation();
    List<String> bookerNames = loginViewModel.bookerNamesBySMDesignation.map((dynamic item) => item.toString()).toSet().toList();
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildAnimatedTextField('SM Name', SMNameController, Icons.person, readOnly: true),
  ...
  Future<void> _handleLogin() async {
    ...
    await shopVisitViewModel.addHeadsShopVisit(HeadsShopVisitModel(
      ...
      userId: userId,
      bookerName: SMNameController.text,
